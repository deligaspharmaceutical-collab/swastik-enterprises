...
import { ArrowRight, CheckCircle2, ChevronRight, Award, ShieldCheck, Droplets, Layers } from "lucide-react";

export default function LaminationAdhesivePage() {
  const specs = [
    ...
    { label: "Solid Content", value: "35% - 40% (as supplied)" },
    { label: "Viscosity", value: "15 - 25 seconds (Ford Cup 4)" },
    { label: "Application Temp", value: "Room Temperature" },
  ];

  const features = [
    {
      title: "Superior Film Adhesion",
      desc: "Outstanding bonding on treated BOPP, PET, CPP, and metallized films.",
      icon: Layers,
    },
    {
      title: "Optical Clarity",
      desc: "High transparency with excellent gloss, ensuring printed graphics remain sharp and vivid.",
      icon: Award,
    },
    {
      title: "Low Solvent Retention",
      desc: "Fast solvent release minimizing residual odors, crucial for food packaging applications.",
      icon: Droplets,
    },
    {
      title: "FDA Compliant",
      desc: "Meets FDA 175.105 requirements for safe indirect food contact packaging.",
      icon: ShieldCheck,
    },
  ];

  const applications = [
    "Flexible Food Packaging Lamination",
    "Snack & Confectionery Wrappers",
    "Pet Food Pouches & Stand-Up Bags",
    "Aluminum Foil to Film Laminations",
          ...
          <section className="relative overflow-hidden bg-brand-dark pt-32 pb-20 text-white md:pt-44 md:pb-32">
            ...
            <div className="mx-auto max-w-7xl px-6 md:px-12 relative z-10">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-zinc-400 mb-6 uppercase tracking-wider">
                ...
                <ChevronRight className="h-3 w-3" />
                <span className="text-zinc-200">Lamination Adhesive</span>
              </div>
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-6 font-body text-lg text-zinc-300 leading-relaxed">
                  High-performance solvent-based and solvent-free synthetic resins optimized for dry lamination, flexible food packaging, and film-to-film conversions.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7 space-y-12">
                  <div className="space-y-6">
                    <h2 className="font-display text-3xl font-black text-brand-dark">
                      Optimized for High-Speed Converters
                    </h2>
                    <p className="font-body text-base text-zinc-600 leading-relaxed">
                      Our Lamination Adhesives are engineered to meet the demanding requirements of modern flexible packaging converters. Formulated using advanced polyurethane and polyether technologies, they provide excellent wettability on plastic films and aluminum foils, maintaining high green bond strength to prevent tunneling. With optimized curing rates, they allow for fast slitting and processing of laminates, reducing turnaround times.
                    </p>
                  </div>
                ...
                <div className="lg:col-span-5 space-y-10">
                  ...
                  <div className="bg-brand-dark text-white rounded-3xl p-8 shadow-md">
                    ...
                    <div className="mt-8">
                      <Link
                        href="/contact?inquiry=lamination-adhesive"
